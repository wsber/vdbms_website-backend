"""
Django settings for vdbms_ws project.
...
SECRET_KEY = 'django-insecure-2h(obgx0k(^%6o^i1hliq8+ya1k-v^f6(ox=sjug5fccgz#q&4'
...
JWT_AUTH = {
    'JWT_SECRET_KEY': 'YOUR_SECRET_KEY',  # 替换成您的密钥
    'JWT_ALGORITHM': 'HS256',
    'JWT_VERIFY': True,
    ...
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'seiden.utils.my_jwt_response_handler'
}
ROOT_URLCONF = 'vdbms_ws.urls'
